export const NINE = (ref) => {
    // Animation array for number "9" position in Indian Sign Language
    let animations = []
    
    // Right arm configuration - positioned to show "9"
    ...
    // In ISL, "9" is shown with index finger curved to make a hook shape
    
    // Curl index finger partially to make a hook shape
    animations.push(["mixamorigRightHandIndex1", "rotation", "z", 0, "+"]);
    animations.push(["mixamorigRightHandIndex2", "rotation", "z", Math.PI/2, "+"]);  // Bend at middle joint
    animations.push(["mixamorigRightHandIndex3", "rotation", "z", Math.PI/3, "+"]);  // Slight bend at tip
