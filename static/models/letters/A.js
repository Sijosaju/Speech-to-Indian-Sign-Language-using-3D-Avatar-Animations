window.A = (ref) => {
  ...
  animations.push(["mixamorigLeftHandIndex2", "rotation", "y", -Math.PI/9, "-"]);
  animations.push(["mixamorigLeftHandMiddle3", "rotation", "y", -Math.PI/18, "-"]);
  animations.push(["mixamorigLeftHandRing2", "rotation", "y", Math.PI/18, "+"]);
  animations.push(["mixamorigLeftHandPinky2", "rotation", "y", Math.PI/9, "+"]);
  ...
  animations.push(["mixamorigLeftHandIndex2", "rotation", "y", 0, "+"]);
  animations.push(["mixamorigLeftHandMiddle3", "rotation", "y", 0, "+"]);
  animations.push(["mixamorigLeftHandRing2", "rotation", "y", 0, "-"]);
  animations.push(["mixamorigLeftHandPinky2", "rotation", "y", 0, "-"]);
