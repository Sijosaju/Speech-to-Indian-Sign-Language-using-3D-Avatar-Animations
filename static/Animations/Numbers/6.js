export const SIX = (ref) => {
    // Animation array for number "6" position in Indian Sign Language
    let animations = []
    
    // Right arm configuration - positioned to show "6"
    ...
    // In ISL, "6" is shown with thumb and pinky extended, other fingers curled
